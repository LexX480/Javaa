...
const SignUp = () => {
  const [userSignUp, { isLoading, error }] = useUserRegisterMutation();
    ...
    <form onSubmit={formik.handleSubmit}>
      <Card className="mx-auto pt-4 max-w-80" color="transparent" shadow={false}>
        ...
        <form className="mt-5">
          ...
          {isLoading ? <Button disabled fullWidth loading={true}>Loading</Button> : <Button type="submit" className="mt-6" fullWidth>
            SignUp
          </Button>}
