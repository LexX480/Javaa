...
const Header = () => {
  ...
  return (
    <div className='flex justify-between bg-black text-white px-7 py-3 items-start '>
      <div className=" flex flex-col items-start">
        <img src={logo} alt="logo" style={{ width: 40 }} />
        Codepen
      </div>
      <nav className='space-x-3'> <button className="bg-gray-700 rounded-md h-10 w-[100px]">Save</button> <button className="bg-green-500 rounded-md h-10 w-[100px]">Sign Up</button>
